...
-- 创建 17 张旅游业务表 (按外键依赖顺序)
-- 沿用原业务系统表结构, 语义迁移为旅游 OTA 场景:
--   sku_info        = 旅游产品 (酒店/门票/跟团游/机票/火车票/租车)
--   order_info      = 预订订单 (新增 travel_date 出行日期, travel_persons 出行人数)
--   receive_info    = 出行人/行程信息 (receive_city = 目的地城市)
